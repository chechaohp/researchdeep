...
def is_valid_word(word, hand, word_list):
    ...
    if word in word_list:
        require_letters = get_frequency_dict(word)
        for key in require_letters.keys():
            if key in hand.keys():
                if require_letters[key] > hand[key]:
                    result = False
            else:
                result = False
    else:
...
def play_hand(hand, word_list):
    ...
    * The final score is displayed.
    ...
    while (1):
        ...
        print("Input a word or . to finish your game")
        word = input()
        time_play = round(time.time()-start_time,2)
        print("It takes",time_play,"seconds to complete")
        time_remain = time_total - time_play
        if time_remain > 0:
            print("You have",time_remain,"seconds remain")
        else:
            print("You have ran out of time")
